...
Hop turns one VS Code window into a persistent shell for your worktrees. Run **Hop: Go** to search every worktree Hop knows about by repository, branch, PR number (`flipbook#482`), or PR title, then switch to it in the same window.
